...
![Requests per Second]({{ '/assets/img/requests.png' | relative_url }})X: concurrent connections. Y: requests per second{: .mx-auto.d-block width="100%"}

![Latency]({{ '/assets/img/requests.png' | relative_url }})X: concurrent connections. Y: latency in microseconds{: .mx-auto.d-block width="100%"}
